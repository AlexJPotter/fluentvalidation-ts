...
export type RuleValidators<TModel, TValue> = {
  ...
  maxLength: IfString<
    TValue,
    (maxLength: number) => RuleValidatorsAndExtensions<TModel, TValue>
  >;
  minLength: IfString<
    TValue,
    (minLength: number) => RuleValidatorsAndExtensions<TModel, TValue>
  >;
  matches: IfString<
    TValue,
    (pattern: RegExp) => RuleValidatorsAndExtensions<TModel, TValue>
  >;
  emailAddress: IfString<
    TValue,
    () => RuleValidatorsAndExtensions<TModel, TValue>
  >;
  lessThan: IfNumber<
